      ...
      <div className="pt-8 pb-20 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-[#333333] mb-2">Stack Name *</label>
            ...
            <p className="text-xs text-[#999999] text-center">Add listings to your stack after creating it.</p>
          </form>
        </div>
      </div>
      <Footer />
