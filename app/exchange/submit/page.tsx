      ...
      <div className="pt-8 pb-20 px-6">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-2 text-sm mb-6">
            ...
            <span className="text-[#333333] font-medium">Submit</span>
          </div>
          ...
          {/* GitHub Import */}
          <div className="bg-[#f8f9fb] rounded-xl p-5 border border-[#dbdbdb] mb-8">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 rounded-lg bg-[#ffffff] border border-[#dbdbdb] text-[#333333] text-sm placeholder-[#999999] focus:outline-none focus:border-[#0061aa] transition-colors"
              />
              <button
                type="button"
                ...
                className="px-5 py-2.5 rounded-lg bg-[#0061aa] hover:bg-[#004d88] disabled:opacity-50 text-white text-sm font-semibold transition-colors shrink-0"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-[#999999] mt-1">{title.length}/200</p>
            </div>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-colors ${
                      platforms.includes(p.value)
                        ? "text-white"
                        : "bg-[#f8f9fb] text-[#777777] border border-[#dbdbdb] hover:text-[#333333]"
                    }`}
                    style={
                      platforms.includes(p.value)
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-[#f8f9fb] border border-[#dbdbdb] text-[#333333] text-sm placeholder-[#999999] focus:outline-none focus:border-[#0061aa] transition-colors"
              />
              <p className="text-xs text-[#999999] mt-1">Comma-separated. Max 10 tags, 30 chars each.</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg bg-[#ffffff] border border-[#dbdbdb] text-[#555555] text-sm font-mono placeholder-[#999999] focus:outline-none focus:border-[#0061aa] transition-colors resize-none"
              />
            </div>
              ...
              {screenshotUrl && (
                <div className="mt-3">
                  <img
                    src={screenshotUrl}
                    alt="Preview"
                    className="max-h-48 rounded-lg border border-[#dbdbdb]"
            ...
            {/* Remix notice */}
            {isRemix && (
              <div className="bg-[#0061aa]/10 border border-[#0061aa]/30 rounded-lg px-4 py-3 text-sm text-[#0061aa]">
