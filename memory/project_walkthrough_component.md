...
metadata: 
  ...
  modified: 2026-08-24T19:39:52.855Z
---

> **NO LONGER ON THE SITE — 2026-08-24.** Russell pointed at the walkthrough
> card on the live page and said "remove this". Commit `68a35b7` removed
> `<Walkthrough />` from `app/page.tsx` and dropped its import. **The component
> is still defined and exported in `app/components.tsx`**, so putting it back is
> one line — but it renders nowhere today. Everything below describes how it
> worked, not what is live. The walkthrough images it used are still in
> `public/images/walkthrough/` (now unreferenced).
